...
public class UserConsumeNew extends Model< UserConsumeNew > {
    ...
    @TableField( "couponDisCountMoney" )
    private Double couponDisCountMoney;

    @TableField( "fenbiDisountMoney" )
    private Double fenbiDisountMoney;


    @TableField( "jifenDisCountMoney" )
    private Double jifenDisCountMoney;


    @TableField( "jifenBalance" )
    private Integer jifenBalance;

    @TableField( "fenbiBalance" )
    private Double fenbiBalance;
	...
	return "UserConsumeNew{" + "id=" + id + ", busId=" + busId + ", memberId=" + memberId + ", mcId=" + mcId + ", ctId=" + ctId + ", gtId=" + gtId + ", recordType="
			+ recordType + ", ucType=" + ucType + ", totalMoney=" + totalMoney + ", integral=" + integral + ", fenbi=" + fenbi + ", uccount=" + uccount
			+ ", discountMoney=" + discountMoney + ", discountAfterMoney=" + discountAfterMoney + ", changeFlow=" + changeFlow + ", dvId=" + dvId + ", disCountdepict="
			+ disCountdepict + ", cardType=" + cardType + ", balance=" + balance + ", flowState=" + flowState + ", dataSource=" + dataSource + ", isend=" + isend
			+ ", ischongzhi=" + ischongzhi + ", isendDate=" + isendDate + ", refundMoney=" + refundMoney + ", orderCode=" + orderCode + ", shopId=" + shopId
			+ ", createDate=" + createDate + ", payStatus=" + payStatus + ", balanceCount=" + balanceCount + ", refundFenbi=" + refundFenbi + ", refundJifen="
			+ refundJifen + ", refundDate=" + refundDate + ", flowbalance=" + flowbalance + ", fukaCtId=" + fukaCtId + "}";
    }
}
