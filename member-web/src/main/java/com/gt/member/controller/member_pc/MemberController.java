...
public class MemberController {
    ...
    @ApiImplicitParams( { @ApiImplicitParam( name = "memberIds", value = "会员卡memberId集合逗号隔开", paramType = "query", required = false, dataType = "string" ),
    ...
    public ServerResponse cardBatchApplyChecked( HttpServletRequest request, HttpServletResponse response, @RequestParam String params ) {
	try {
    ...
    @ApiImplicitParams( { @ApiImplicitParam( name = "memberId", value = "会员卡memberId", paramType = "query", required = false, dataType = "int" ),
		    @ApiImplicitParam( name = "ischecked", value = "审核状态 0不通过 1通过", paramType = "query", required = false, dataType = "int" )

    } )
    @ResponseBody
    @RequestMapping( value = "/cardApplyCheckedByOne", method = RequestMethod.POST )
    public ServerResponse cardApplyCheckedByOne( HttpServletRequest request, HttpServletResponse response, @RequestParam String params ) {
	try {
	    JSONObject obj = JSON.parseObject( params );
    ...
    public ServerResponse addIntegralAndfenbi( HttpServletRequest request, HttpServletResponse response, @RequestParam String json ) {
	try {
	    Integer busId = SessionUtils.getPidBusId( request );
    ...
    public ServerResponse sendNoticeToUser( HttpServletRequest request, HttpServletResponse response, Integer id, String memberIds ) {
	try {
    ...
    @ApiImplicitParams( { @ApiImplicitParam( name = "mcId", value = "会员卡id", paramType = "query", required = false, dataType = "int" ),
    ...
    public ServerResponse updateDis( HttpServletRequest request, HttpServletResponse response, Integer mcId, Integer cardStatus ) {
	try {
    ...
    public ServerResponse deleteMember( HttpServletRequest request, HttpServletResponse response, Integer memberId ) {
	try {
    ...
    @ApiOperation( value = "查询身份证信息", notes = "查询身份证信息" )
    @ApiImplicitParam( name = "memberId", value = "会员id", paramType = "query", required = false, dataType = "int" )
    @ResponseBody
    @RequestMapping( value = "/findCardImage", method = RequestMethod.GET )
    public ServerResponse findCardImage( HttpServletRequest request, HttpServletResponse response, @RequestParam Integer memberId ) {
	try {
	    Map< String,Object > map = memberCardService.findCardImage( memberId );
	    return ServerResponse.createBySuccess( map );
	} catch ( Exception e ) {
	    LOG.error( "查询身份证信息异常：", e );
	    e.printStackTrace();
	    return ServerResponse.createByError();
	}
    }

    @ApiOperation( value = "审核身份证", notes = "审核身份证" )
    @ApiImplicitParam( name = "memberId", value = "会员id", paramType = "query", required = false, dataType = "int" )
    @ResponseBody
    @RequestMapping( value = "/checkCard", method = RequestMethod.POST )
    public ServerResponse checkCard( HttpServletRequest request, HttpServletResponse response, @RequestParam String json ) {
	try {
	    memberCardService.checkCard( json );
	    return ServerResponse.createBySuccess();
	} catch ( Exception e ) {
	    LOG.error( "审核身份证异常：", e );
	    e.printStackTrace();
    ...
    @ApiImplicitParams( { @ApiImplicitParam( name = "memberId", value = "会员id", paramType = "query", required = false, dataType = "int" ) } )
    @ResponseBody
    @RequestMapping( value = "/findMemberDetails", method = RequestMethod.GET )
    public ServerResponse findMemberDetails( HttpServletRequest request, HttpServletResponse response, Integer memberId ) {
    ...
    public ServerResponse findMemberByMemberId( HttpServletRequest request, HttpServletResponse response, Integer memberId ) {
	try {
    ...
    public ServerResponse updateMember( HttpServletRequest request, HttpServletResponse response, @RequestParam String json ) {
	try {
    ...
    public ServerResponse upLoadMember( HttpServletRequest request, HttpServletResponse response ) {
	try {
    ...
    @ApiImplicitParams( { @ApiImplicitParam( name = "redisStr", value = "redisStr 导入错误下载标示", paramType = "query", required = false, dataType = "int" ) } )
    @ResponseBody
    @RequestMapping( value = "/downExecl", method = RequestMethod.GET )
    public void downExecl( HttpServletRequest request, HttpServletResponse response, String redisStr ) {
	try {
	    ...
	    response.addHeader( "Content-Disposition", "attachment;filename=" + new String( saveFileName.replaceAll( " ", "" ).getBytes( "utf-8" ), "iso8859-1" ) );
    ...
    @ApiImplicitParams( { @ApiImplicitParam( name = "ctId", value = "会员卡类型 -1实体卡  ", paramType = "query", required = false, dataType = "int" ),
    ...
    public void exportMember( HttpServletRequest request, HttpServletResponse response, @RequestParam Integer ctId, @RequestParam Integer gtId ) {
	try {
	    Integer busId = SessionUtils.getPidBusId( request );
	    List< Map< String,Object > > listMap = memberCardService.findMember( busId, ctId, gtId );
    ...
    @ApiImplicitParams( { @ApiImplicitParam( name = "cardNo", value = "卡号", paramType = "query", required = false, dataType = "int" ) } )
    @ResponseBody
    @RequestMapping( value = "/findMemberCardByCardNo", method = RequestMethod.GET )
    public ServerResponse findMemberCardByCardNo( HttpServletRequest request, HttpServletResponse response, String cardNo ) {
	try {
	    Integer busId = SessionUtils.getPidBusId( request );
    ...
    public ServerResponse intergralConsume( HttpServletRequest request, HttpServletResponse response, String cardNo, Integer intergral ) {
	try {
	    Integer busId = SessionUtils.getPidBusId( request );
    ...
    @ApiImplicitParams( { @ApiImplicitParam( name = "ctId", value = "会员卡类型 第一次默认传0", paramType = "query", required = false, dataType = "int" ) } )
    @ResponseBody
    @RequestMapping( value = "/memberTongJi", method = RequestMethod.GET )
    public ServerResponse memberTongJi( HttpServletRequest request, HttpServletResponse response, Integer ctId ) {
	try {
	    Integer busId = SessionUtils.getPidBusId( request );
    ...
    public ServerResponse sum7DayOrder( HttpServletRequest request, HttpServletResponse response, Integer ctId, String startdate, String enddate ) {
	try {
	    Integer busId = SessionUtils.getPidBusId( request );
    ...
    @ApiImplicitParams( { @ApiImplicitParam( name = "cardNo", value = "卡号、手机号", paramType = "query", required = false, dataType = "String" ),
    ...
    public ServerResponse findChongZhiLog( HttpServletRequest request, HttpServletResponse response, @RequestParam String params ) {
	try {
	    Integer busId = SessionUtils.getPidBusId( request );
    ...
    @ApiImplicitParams( { @ApiImplicitParam( name = "ucId", value = "订单id", paramType = "query", required = false, dataType = "int" ) } )
    @ResponseBody
    @RequestMapping( value = "/findChongZhiLogDetails", method = RequestMethod.GET )
    public ServerResponse findChongZhiLogDetails( HttpServletRequest request, HttpServletResponse response, Integer ucId ) {
	try {
    ...
    public ServerResponse findDuiHuanLog( HttpServletRequest request, HttpServletResponse response, @RequestParam String params ) {
	try {
	    Integer busId = SessionUtils.getPidBusId( request );
    ...
    public ServerResponse findDuiHuanLogDetails( HttpServletRequest request, HttpServletResponse response, Integer ucId ) {
	try {
    ...
    public ServerResponse findCiKaLog( HttpServletRequest request, HttpServletResponse response, @RequestParam String params ) {
	try {
	    Integer busId = SessionUtils.getPidBusId( request );
    ...
    public ServerResponse findCiKaLogDetails( HttpServletRequest request, HttpServletResponse response, Integer ucId ) {
	try {
    ...
    public ServerResponse findXiaoFeiLog( HttpServletRequest request, HttpServletResponse response, @RequestParam String params ) {
	try {
	    Integer busId = SessionUtils.getPidBusId( request );
	    Map< String,Object > param = JSON.toJavaObject( JSON.parseObject( params ), Map.class );
    ...
    public ServerResponse findXiaoFeiLogDetails( HttpServletRequest request, HttpServletResponse response, Integer ucId ) {
	try {
    ...
    @ApiImplicitParams( { @ApiImplicitParam( name = "phone", value = "卡号、手机号", paramType = "query", required = false, dataType = "String" ) } )
    @ResponseBody
    @RequestMapping( value = "/findMemberCommend", method = RequestMethod.GET )
    public ServerResponse findMemberCommend( HttpServletRequest request, HttpServletResponse response, @RequestParam String params ) {
	try {
    ...
    public ServerResponse findCardCommend( HttpServletRequest request, HttpServletResponse response, @RequestParam String params ) {
	try {
	    Map< String,Object > map = JSON.parseObject( params, Map.class );
	    Integer busId = SessionUtils.getPidBusId( request );
    ...
    @ApiImplicitParams( { @ApiImplicitParam( name = "phone", value = "手机号", paramType = "query", required = false, dataType = "String" ) } )
    @ResponseBody
    @RequestMapping( value = "/findPickLog", method = RequestMethod.GET )
    public ServerResponse findPickLog( HttpServletRequest request, HttpServletResponse response, @RequestParam String params ) {
	try {
	    Map< String,Object > map = JSON.parseObject( params, Map.class );
	    Integer busId = SessionUtils.getPidBusId( request );
    ...
    @ApiImplicitParams( { @ApiImplicitParam( name = "phone", value = "手机号或卡号", paramType = "query", required = false, dataType = "String" ) } )
    @ResponseBody
    @RequestMapping( value = "/findMemberCardByrecharge", method = RequestMethod.GET )
    public ServerResponse findMemberCardByrecharge( HttpServletRequest request, HttpServletResponse response, String phone ) {
	try {
	    Integer busId = SessionUtils.getPidBusId( request );
    ...
    @ApiImplicitParams( { @ApiImplicitParam( name = "cardNo", value = "手机号或卡号", paramType = "query", required = false, dataType = "String" ),
    ...
    public ServerResponse rechargeMemberCard( HttpServletRequest request, HttpServletResponse response, String params ) {
	try {
	    Integer busId = SessionUtils.getPidBusId( request );
    ...
    public ServerResponse findBusUserShop( HttpServletRequest request, HttpServletResponse response ) {
	try {
	    Integer busId = SessionUtils.getPidBusId( request );
    ...
    public ServerResponse consumefindMemberCard( HttpServletRequest request, HttpServletResponse response, String cardNo, Integer shopId ) {
	try {
	    Integer busId = SessionUtils.getPidBusId( request );
    ...
    public ServerResponse consumeMemberCard( HttpServletRequest request, HttpServletResponse response, String params ) {
	try {
	    Integer busId = SessionUtils.getPidBusId( request );
	    Integer dangqianbusId = SessionUtils.getLoginUser( request ).getId();
