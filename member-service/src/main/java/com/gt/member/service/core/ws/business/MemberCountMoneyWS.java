...
import com.gt.member.service.core.ws.entitybo.count.MallAllEntity;
import com.gt.member.service.core.ws.entitybo.count.MallEntity;
import com.gt.member.service.core.ws.entitybo.count.MallShopEntity;
import com.gt.member.service.core.ws.entitybo.count.MemberShopEntity;
 ...
 */
public class MemberCountMoneyWS {
    private static final Logger LOG = Logger
		    .getLogger(MemberCountMoneyWS.class);
	...
	if (ce.isUseCoupon()) {
		...
		// 微信优惠券
		wxCardReceive = wxCardReceiveMapper.selectById(ce
				.getCoupondId());
		...
		// 多粉优惠券
		dfget = duofenCardGetMapper.selectById(ce
				.getCoupondId());
