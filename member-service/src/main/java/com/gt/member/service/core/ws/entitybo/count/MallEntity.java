...
public class MallEntity {
	...
	private Integer mallId;  //订单详情id or 生成序列号
	private Integer number=1;  // 商品数量
	private Double totalMoneyOne;  //商品应付单价格
	private Double totalMoneyAll; //商品订单总价格  用来计算
	
	private Integer userCard=0;  //是否能用会员卡打折
	...
	private Double jifenNum=0.0;  //使用积分数量 不存在set
