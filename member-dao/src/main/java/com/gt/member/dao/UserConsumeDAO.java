...
public interface UserConsumeDAO extends BaseMapper<UserConsume> {
     ...
     * 分页查询
     */
    List<Map<String,Object>> findUserConume(@Param("busId")Integer busId, @Param("first")Integer first,
                                            @Param("pageSize")Integer pageSize, @Param("ctId")Integer ctId, @Param("recordType")Integer recordType,
                                            @Param("startDate")String startDate, @Param("endDate")String endDate, @Param("search")String search);

    int countUserConume(@Param("busId")Integer busId,@Param("ctId")Integer ctId,@Param("recordType")Integer recordType,
                        @Param("startDate")String startDate,@Param("endDate")String endDate,@Param("search")String search);
     ...
     * 查询卡券核销记录
     */
    List<Map<String, Object>> findWxcardReceive(@Param("busId")Integer busId,@Param("first")Integer first,
                                                @Param("pageSize")Integer pageSize,@Param("shopIds")List<Integer> shopIds,@Param("cardType")Integer cardType);
     ...
     * 分页查询
     */
    List<Map<String,Object>> findUserConume1(@Param("busId")Integer busId,@Param("first")Integer first,
                                             @Param("pageSize")Integer pageSize,@Param("recordType")Integer recordType,
                                             @Param("startDate")String startDate,@Param("endDate")String endDate,@Param("payStatus")Integer payStatus);

    int countUserConume1(@Param("busId")Integer busId,@Param("recordType")Integer recordType,
                         @Param("startDate")String startDate,@Param("endDate")String endDate,@Param("payStatus")Integer payStatus);
     ...
     * 查询卡券核销记录
     */
    List<Map<String, Object>> findDuofencardReceive(@Param("busId")Integer busId,@Param("first")Integer first,
                                                    @Param("pageSize")Integer pageSize,@Param("shopIds")List<Integer> shopIds,@Param("cardType")Integer cardType);
    ...
    int countUserConumeByMember(@Param("busId")Integer busId,@Param("memberId")Integer memberId,
                                @Param("startDate")String startDate,@Param("endDate")String endDate);
